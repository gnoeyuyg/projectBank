...
<section class="bg-light py-5">
    <div class="container px-5 my-5">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bolder">해지 성공</h2>
            <p>Your savings account has been successfully terminated.</p>
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/savings/savingslistaccounts">Back to Accounts</a>
        </div>
    </div>
</section>
