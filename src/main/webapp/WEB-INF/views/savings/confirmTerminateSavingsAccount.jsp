...
<section class="bg-light py-5">
    <div class="container px-5 my-5">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bolder">적금 해지 확인</h2>
            <form action="${pageContext.request.contextPath}/confirmTerminate" method="post">
                ...
                <div class="mb-3">
                    <label for="transferAccountNum" class="form-label">Transfer Account Number:</label>
                    <input type="text" class="form-control" id="transferAccountNum" name="transferAccountNum" required>
                </div>
                <button type="submit" class="btn btn-danger">Confirm Terminate</button>
            </form>
