...
<div class="main-content">
    <div class="container mt-5">
        <h1 class="mb-4">적금 상품 삭제</h1>
        <form action="${pageContext.request.contextPath}/savingsCRUD/delete" method="post">
            <div class="mb-3">
                <label for="depositType" class="form-label">적금 종류:</label>
        ...
        <c:if test="${deleteSuccess}">
            <p class="text-success mt-3">적금 상품이 성공적으로 삭제되었습니다.</p>
        </c:if>
        <c:if test="${deleteFailure}">
            <p class="text-danger mt-3">적금 상품 삭제에 실패했습니다. 다시 시도해주세요.</p>
        </c:if>
    </div>
</div>
<!-- Bootstrap JS -->
